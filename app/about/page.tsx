...
import { FormType } from "@/components/MemberOperation";
...
const Page = () => {
  ...
  const teamMembers = [
    { name: "John Doe", role: "CEO", image: "/images/team-member.png" },
    { name: "Jane Smith", role: "CTO", image: "/images/team-member.png" },
    {
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="mt-16 flex flex-col md:flex-row md:space-x-8 items-center">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            ...
            <h2 className="mt-12 text-4xl font-bold text-blue-200">
              Our Mission
            </h2>
            <p className="mt-6 text-lg text-blue-50 leading-relaxed">
              Our mission is to deliver innovative and reliable IT solutions
              that enable our clients to improve efficiency, drive growth, and
            ...
            <ul className="mt-6 space-y-4 text-lg text-blue-50">
              {[
                "Customer Focus: We put our clients at the center of everything we do.",
                "Integrity: We uphold the highest standards of integrity in all of our actions.",
                "Innovation: We strive to develop creative solutions to complex challenges.",
              ].map((value, index) => (
        ...
        <div className="mt-20 text-center">
          <h2 className="text-4xl font-bold text-blue-200">Meet Our Team</h2>
          <p className="mt-6 text-xl text-blue-100">
            Our team of dedicated professionals is here to help you achieve your
            IT goals.
          </p>
          <div className="mt-12 flex flex-wrap justify-center gap-8">
            {allTeamMembers.map((member, index) => (
              <div
                key={index}
                className="flex flex-col items-center w-64 p-6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl transform transition duration-300 hover:scale-105"
              >
                <div className="w-32 h-32 mb-4 overflow-hidden rounded-full bg-blue-300">
                  <img
                ...
                <p className="mt-2 text-lg text-blue-300">{member.position}</p>
