...
const PortfolioOperationSection = () => {
  ...
  const submitPortfoliohandler = async (
    ...
    const response = await axios.post("/api/addportfolio", dataToBackend, {
...
export default PortfolioOperationSection;
